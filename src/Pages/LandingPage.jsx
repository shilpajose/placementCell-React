    ...
    <>
     {/* <!-- Navigation--> */}
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top" >Placement-Cell</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <Link to={'/login'} style={{textDecoration:'none'}} className='btn btn-danger'>LOGIN</Link>
                </div>
            </div>
        </nav>
        {/* <!-- Masthead--> */}
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Welcome To Our Placement-Cell!</div>
                <div class="masthead-heading text-uppercase">It's Nice To Meet You</div>
                <a class="btn btn-primary btn-xl text-uppercase" href="#services">Getting Started</a>
            </div>
        </header>
        {/* <!-- Services--> */}
        ...
        <div class="py-5">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="https://startbootstrap.github.io/startbootstrap-agency/assets/img/logos/google.svg" alt="..." aria-label="Google Logo" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="https://startbootstrap.github.io/startbootstrap-agency/assets/img/logos/facebook.svg" alt="..." aria-label="Facebook Logo" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="https://startbootstrap.github.io/startbootstrap-agency/assets/img/logos/ibm.svg" alt="..." aria-label="IBM Logo" /></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                ...
                <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                    ...
                    {/* <!-- Submit Button--> */}
                    <div class="text-center"><button onClick={handleMailsend} class="btn btn-primary btn-xl text-uppercase" id="submitButton" type="submit">Send Message</button></div>
                </form>
            </div>
        </section>
        {/* <!-- Footer--> */}
